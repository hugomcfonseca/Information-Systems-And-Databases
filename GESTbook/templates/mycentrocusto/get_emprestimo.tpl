...
{if $s_type == "user"}
    ...
    <p>
        {if $my_emprestimos1.resposta=="Pendente"}
        [<a class="navtext" href="close.php?id={$my_emprestimos1.emprestimo_id}&resp=Aceite">Aceitar</a>]
        [<a class="navtext" href="close.php?id={$my_emprestimos1.emprestimo_id}&resp=Recusado">Recusar</a>]
        {/if}

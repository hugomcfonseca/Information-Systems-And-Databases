...
// check privileges
if ($s_type != "user" || $_POST["responsavel"] != $responsavel) {
...
$errors = Centrocustos::update($id, $name, $acronym, $descritive, $value_orcament, $cost_type, $cycle, $responsible);	
...
if ($errors) {
  ...
  $_SESSION["s_messages"][] = 'Centro de custos alterado com sucesso';
